...
@interface Upcoming (){
    ...
    NSString *sURL, *strResult, *sRemaining, *sLanguage;
}
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    if ([sLanguage isEqualToString:@"CN"]){
        ...
        self.navigationController.navigationBar.topItem.title = @"即将报表";
        
    }else{
        self.navigationController.navigationBar.topItem.title = @"UPCOMING SCHEDULE";
    }
}
