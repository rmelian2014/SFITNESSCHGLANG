...
- (void)setupTabBar {
    ...
    if(tabBarController != nil) {
        ((UIViewController*)[tabBarController.viewControllers objectAtIndex:1]).tabBarItem.title = @"课程";
        ((UIViewController*)[tabBarController.viewControllers objectAtIndex:2]).tabBarItem.title = @"健身房";
        ((UIViewController*)[tabBarController.viewControllers objectAtIndex:3]).tabBarItem.title = @"搜索";
        ((UIViewController*)[tabBarController.viewControllers objectAtIndex:4]).tabBarItem.title = @"更多";
